...
public class Pub_gralLocator extends org.apache.axis.client.Service implements com.ipartek.formacion.ua.web_service_SOAP.Pub_gral {
    ...
    public com.ipartek.formacion.ua.web_service_SOAP.Pub_gralSoap getpub_gralSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.ipartek.formacion.ua.web_service_SOAP.Pub_gralSoap getpub_gralSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.ipartek.formacion.ua.web_service_SOAP.Pub_gralSoapStub _stub = new com.ipartek.formacion.ua.web_service_SOAP.Pub_gralSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ipartek.formacion.ua.web_service_SOAP.Pub_gralSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.ipartek.formacion.ua.web_service_SOAP.Pub_gralSoapStub _stub = new com.ipartek.formacion.ua.web_service_SOAP.Pub_gralSoapStub(new java.net.URL(pub_gralSoap_address), this);
                _stub.setPortName(getpub_gralSoapWSDDServiceName());
                return _stub;
            }
        }
